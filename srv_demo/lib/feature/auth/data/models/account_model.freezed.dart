...
abstract class $AccountModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'Email') @HiveField(0) String email,
      @JsonKey(name: 'Password') @HiveField(1) String password});
}
...
class _$AccountModelImpl extends _AccountModel {
  _$AccountModelImpl(
      {@JsonKey(name: 'Email') @HiveField(0) required this.email,
      @JsonKey(name: 'Password') @HiveField(1) required this.password})
      : super._();
  ...
  @override
  String toString() {
    return 'AccountModel(email: $email, password: $password)';
  }
...
abstract class _AccountModel extends AccountModel {
  factory _AccountModel(
      {@JsonKey(name: 'Email') @HiveField(0) required final String email,
      @JsonKey(name: 'Password')
      @HiveField(1)
      required final String password}) = _$AccountModelImpl;
