...
class _$AccountEntityImpl implements _AccountEntity {
  const _$AccountEntityImpl({required this.email, required this.password});
  ...
  @override
  String toString() {
    return 'AccountEntity(email: $email, password: $password)';
  }
...
abstract class _AccountEntity implements AccountEntity {
  const factory _AccountEntity(
      ...
      required final String password}) = _$AccountEntityImpl;
